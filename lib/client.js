	...
	factory: (require) => {
		...
		*/
		...
		const zh$5 = {
			...
			enabled: "启用动效",
			enabledDesc: "开启后，设置页、用量面板、历史条与新消息等元素以动画方式出现。",
			style: "动效风格",
			styleDesc: "调整动画的时长、缓动曲线与位移幅度。",
			"style.soft": "柔和",
			"style.standard": "标准",
			"style.lively": "活泼",
			"style.softDesc": "更慢更轻的过渡，克制而安静。",
			"style.standardDesc": "均衡的过渡，快而利落，无回弹。",
			"style.livelyDesc": "更快更明显的过渡，带轻微弹性。",
			preset: "预设方案",
			presetDesc: "一键套用整套动效组合。",
			"preset.balanced": "平衡",
			"preset.focus": "专注",
			"preset.balancedDesc": "完整动效：淡入 + 轻微位移，兼顾质感与克制。",
			"preset.focusDesc": "只保留淡入，去掉位移与缩放，最小化视觉干扰。"
		};
		/** English copy. */
		const en$5 = {
			nav: "Motion",
			...
			enabledDesc: "Settings pages, the usage panel, the history strip and new messages appear with animation when on.",
			style: "Motion style",
			styleDesc: "Adjusts duration, easing curve and travel distance.",
			"style.soft": "Soft",
			"style.standard": "Standard",
			"style.lively": "Lively",
			"style.softDesc": "Slower, lighter transitions — restrained and quiet.",
			"style.standardDesc": "Balanced transitions — quick and crisp, no overshoot.",
			"style.livelyDesc": "Faster, more pronounced transitions with a hint of spring.",
			preset: "Preset",
			presetDesc: "Apply a whole motion combination in one click.",
			"preset.balanced": "Balanced",
			"preset.focus": "Focus",
			"preset.balancedDesc": "Full motion: fade plus a subtle rise — texture with restraint.",
			"preset.focusDesc": "Fade only, no travel or scale — minimal visual noise."
		};
		//#endregion
		//#region \0dsh-css:D:\ZcodeWorkspace\.zcode\workspace\default\deepseek-harness\packages\client\ui-custom\src\client\animation\AnimationSection.module.css.mjs
		const css$15 = ".GDOZ2G_section{flex-direction:column;gap:20px;display:flex}.GDOZ2G_heading{margin:0;font-size:16px;font-weight:600}.GDOZ2G_intro{color:var(--dsw-alias-label-secondary);margin:0;font-size:13px;line-height:20px}.GDOZ2G_row{flex-direction:column;gap:8px;display:flex}.GDOZ2G_rowTitle{font-size:13px;font-weight:500}.GDOZ2G_rowDesc{color:var(--dsw-alias-label-secondary);margin:0;font-size:12px;line-height:18px}.GDOZ2G_switchRow{justify-content:space-between;align-items:center;gap:16px;display:flex}.GDOZ2G_rowText{flex-direction:column;gap:2px;display:flex}.GDOZ2G_switch{flex:none;align-items:center;display:inline-flex;position:relative}.GDOZ2G_checkbox{width:18px;height:18px;accent-color:var(--dsw-alias-brand-primary,var(--dsw-static-deepseek-500))}.GDOZ2G_options{flex-direction:column;gap:6px;display:flex}.GDOZ2G_option{border:1px solid var(--dsw-alias-border,var(--dsw-static-hairline));color:inherit;text-align:left;cursor:pointer;background:0 0;border-radius:8px;justify-content:space-between;align-items:center;gap:12px;padding:8px 10px;font-size:13px;display:flex}.GDOZ2G_option:hover{background:var(--dsw-alias-interactive-bg-hover,#7f7f7f14)}.GDOZ2G_optionActive{border-color:var(--dsw-alias-brand-primary,var(--dsw-static-deepseek-500));background:var(--dsw-alias-interactive-bg-active,#4176e61f)}.GDOZ2G_optionLabel{flex-direction:column;gap:2px;display:flex}.GDOZ2G_optionName{font-weight:500}.GDOZ2G_optionDesc{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:17px}.GDOZ2G_check{color:var(--dsw-alias-brand-primary,var(--dsw-static-deepseek-500));flex:none}";
		const tagId$15 = "@deepseek-ai/dsh-client-ui-custom/AnimationSection.module.css";
		...
		var AnimationSection_module_css_default = {
			"optionLabel": "GDOZ2G_optionLabel",
			"option": "GDOZ2G_option",
			"options": "GDOZ2G_options",
			"rowTitle": "GDOZ2G_rowTitle",
			"optionActive": "GDOZ2G_optionActive",
			"intro": "GDOZ2G_intro",
			"switchRow": "GDOZ2G_switchRow",
			"optionName": "GDOZ2G_optionName",
			"check": "GDOZ2G_check",
			"section": "GDOZ2G_section",
			"heading": "GDOZ2G_heading",
			"row": "GDOZ2G_row",
			"switch": "GDOZ2G_switch",
			"rowText": "GDOZ2G_rowText",
			"rowDesc": "GDOZ2G_rowDesc",
			"checkbox": "GDOZ2G_checkbox",
			"optionDesc": "GDOZ2G_optionDesc"
		};
		//#endregion
		//#region src/client/animation/AnimationSection.tsx
		...
		const STYLES = [
			...
			},
			{
				...
				desc: "style.standardDesc"
			},
			{
				id: "lively",
				label: "style.lively",
				desc: "style.livelyDesc"
			}
		];
		...
		const PRESETS$1 = [{
			...
			desc: "preset.balancedDesc"
		}, {
			id: "focus",
			label: "preset.focus",
			desc: "preset.focusDesc"
		}];
		/**
		* Render the motion section content.
		* @param props - composed slot props + injected controller face.
		*/
		function AnimationSection({ t, useAnimation, setEnabled, setStyle, setPreset }) {
			const value = useAnimation((value) => value)?.value;
			const translator = t;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: AnimationSection_module_css_default.section,
				"data-dsu-motion": "fade-up",
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", {
						className: AnimationSection_module_css_default.heading,
						children: translator("title")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: AnimationSection_module_css_default.intro,
						children: translator("intro")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: AnimationSection_module_css_default.switchRow,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: AnimationSection_module_css_default.rowText,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: AnimationSection_module_css_default.rowTitle,
								children: translator("enabled")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: AnimationSection_module_css_default.rowDesc,
								children: translator("enabledDesc")
							})]
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							className: AnimationSection_module_css_default.switch,
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
								type: "checkbox",
								className: AnimationSection_module_css_default.checkbox,
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: AnimationSection_module_css_default.row,
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: AnimationSection_module_css_default.rowTitle,
								children: translator("style")
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: AnimationSection_module_css_default.rowDesc,
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: AnimationSection_module_css_default.options,
								children: STYLES.map((option) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
									type: "button",
									className: `${AnimationSection_module_css_default.option}${style === option.id ? ` ${AnimationSection_module_css_default.optionActive}` : ""}`,
									"aria-pressed": style === option.id,
									onClick: () => setStyle(option.id),
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										className: AnimationSection_module_css_default.optionLabel,
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											className: AnimationSection_module_css_default.optionName,
											children: translator(option.label)
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											className: AnimationSection_module_css_default.optionDesc,
											children: translator(option.desc)
										})]
									}), style === option.id ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: AnimationSection_module_css_default.check,
										children: "✓"
									}) : null]
								}, option.id))
							})
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: AnimationSection_module_css_default.options,
								children: PRESETS$1.map((option) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
									type: "button",
									className: `${AnimationSection_module_css_default.option}${preset === option.id ? ` ${AnimationSection_module_css_default.optionActive}` : ""}`,
									...
									}), preset === option.id ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: AnimationSection_module_css_default.check,
										children: "✓"
									}) : null]
								}, option.id))
		...
		*/
		...
		const css$11 = ".X1PZLq_hint{z-index:70;border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-overlay) 92%, transparent);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-secondary);pointer-events:none;border-radius:999px;padding:6px 14px;font-size:12px;line-height:18px;position:fixed;bottom:20px;left:50%;transform:translate(-50%)}";
		const tagId$11 = "@deepseek-ai/dsh-client-ui-custom/PreviewBar.module.css";
		...
		*/
		function HistoryStrip({ useSession, loadOlder, sessionId, useHistoryLimit, useHistoryPosition, usePinnedTurns, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				style: {
					...position === "left" ? { "--dsu-strip-x": "-12px" } : { "--dsu-strip-x": "12px" },
					width: STRIP_WIDTH,
		...
		*/
		...
		const css$4 = ".lnBRKq_action{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.lnBRKq_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.lnBRKq_action[data-active]{color:var(--dsu-accent,var(--dsw-alias-brand-primary))}";
		const tagId$4 = "@deepseek-ai/dsh-client-ui-custom/PinTurnAction.module.css";
		...
		*/
		...
		const css$3 = ".iSDaoW_row{justify-content:space-between;align-items:center;gap:16px;padding:12px 0;display:flex}.iSDaoW_rowText{min-width:0}.iSDaoW_title{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.iSDaoW_desc{color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:12px;line-height:18px}.iSDaoW_switch{flex:none;align-items:center;display:inline-flex}.iSDaoW_checkbox{width:16px;height:16px;accent-color:var(--dsw-alias-brand-primary);cursor:pointer}";
		const tagId$3 = "@deepseek-ai/dsh-client-ui-custom/MarkdownRenderRow.module.css";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\ZcodeWorkspace\.zcode\workspace\default\deepseek-harness\packages\client\ui-custom\src\client\animation\animation.module.css.mjs
		const css = "html[data-dsu-anim] [role=dialog]{animation:JgJjdW_dsu-dialog var(--dsu-anim-duration,.2s) var(--dsu-anim-ease,cubic-bezier(.2, 0, 0, 1)) both}html[data-dsu-anim] [role=presentation]{animation:.15s ease-out both JgJjdW_dsu-node}html[data-dsu-anim] [data-dsu-motion=fade-up],html[data-dsu-anim] .JgJjdW_dsu-anim-reveal{animation:JgJjdW_dsu-fade-up var(--dsu-anim-duration,.2s) var(--dsu-anim-ease,cubic-bezier(.2, 0, 0, 1)) both}html[data-dsu-anim] [data-dsu-motion=sheet]{animation:JgJjdW_dsu-sheet var(--dsu-anim-duration,.2s) var(--dsu-anim-ease,cubic-bezier(.2, 0, 0, 1)) both}html[data-dsu-anim] [data-dsu-motion=strip]{animation:JgJjdW_dsu-strip var(--dsu-anim-duration,.2s) var(--dsu-anim-ease,cubic-bezier(.2, 0, 0, 1)) both}html[data-dsu-anim] [data-dsu-motion=node]{animation:.15s ease-out both JgJjdW_dsu-node}html[data-dsu-anim] [data-dsu-motion=press]:active{transition:transform .1s ease-out;transform:scale(.97)}@keyframes JgJjdW_dsu-fade-up{0%{opacity:0;transform:translateY(var(--dsu-anim-rise,6px))}}@keyframes JgJjdW_dsu-dialog{0%{opacity:0;transform:translateY(10px)scale(.99)}}@keyframes JgJjdW_dsu-sheet{0%{opacity:0;transform:scale(.97)}}@keyframes JgJjdW_dsu-strip{0%{opacity:0;transform:translateX(var(--dsu-strip-x,12px))}}@keyframes JgJjdW_dsu-node{0%{opacity:0}}html[data-dsu-anim][data-dsu-preset=focus] [data-dsu-motion=fade-up],html[data-dsu-anim][data-dsu-preset=focus] [data-dsu-motion=strip],html[data-dsu-anim][data-dsu-preset=focus] [data-dsu-motion=sheet],html[data-dsu-anim][data-dsu-preset=focus] .JgJjdW_dsu-anim-reveal,html[data-dsu-anim][data-dsu-preset=focus] [role=dialog],html[data-dsu-anim][data-dsu-preset=focus] [role=presentation]{animation-name:JgJjdW_dsu-node}html[data-dsu-anim][data-dsu-preset=focus] [data-dsu-motion=press]:active{transform:none}@media (prefers-reduced-motion:reduce){html[data-dsu-anim] [data-dsu-motion],html[data-dsu-anim] [role=dialog],html[data-dsu-anim] [role=presentation]{animation-duration:.1s!important}html[data-dsu-anim] [data-dsu-motion=fade-up],html[data-dsu-anim] [data-dsu-motion=strip],html[data-dsu-anim] [data-dsu-motion=sheet],html[data-dsu-anim] .JgJjdW_dsu-anim-reveal,html[data-dsu-anim] [role=dialog],html[data-dsu-anim] [role=presentation]{animation-name:JgJjdW_dsu-node}html[data-dsu-anim] [data-dsu-motion=press]:active{transform:none}}";
		const tagId = "@deepseek-ai/dsh-client-ui-custom/animation.module.css";
		...
		function apply(ctx, config) {
			...
			const registerFeatures = () => {
				...
				if (enabled("animation")) {
					...
					ctx.effect(() => ctx.locale.register(ANIM_NS, {
						zh: zh$5,
						en: en$5
					...
					ctx.slots.inject("settings.section", () => ctx.slots.register({
						...
						inject: () => ({
							...
							setEnabled: (value) => {
								scope.set("animationEnabled", value);
							},
							setStyle: (value) => {
								scope.set("animationStyle", value);
							},
							setPreset: (value) => {
								scope.set("animationPreset", value);
							}
						})
					}, AnimationSection));
					const applyMotion = () => {
					...
					settingsDialogObserver.observe(document.body, {
						childList: true,
						subtree: true
					});
					ctx.effect(() => () => {
