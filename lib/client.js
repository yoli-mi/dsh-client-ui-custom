window.__ModuleLoader__.load({
	id: "@ha-na-bi/dsh-client-ui-custom",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		...
		const css$12 = ".X1PZLq_hint{z-index:70;border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-overlay) 92%, transparent);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-secondary);pointer-events:none;border-radius:999px;padding:6px 14px;font-size:12px;line-height:18px;position:fixed;bottom:20px;left:50%;transform:translate(-50%)}";
		const tagId$12 = "@ha-na-bi/dsh-client-ui-custom/PreviewBar.module.css";
		...
		*/
		...
		const css$5 = ".lnBRKq_action{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.lnBRKq_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.lnBRKq_action[data-active]{color:var(--dsu-accent,var(--dsw-alias-brand-primary))}";
		const tagId$5 = "@ha-na-bi/dsh-client-ui-custom/PinTurnAction.module.css";
		...
		*/
		...
		const css$4 = ".iSDaoW_row{justify-content:space-between;align-items:center;gap:16px;padding:12px 0;display:flex}.iSDaoW_rowText{min-width:0}.iSDaoW_title{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.iSDaoW_desc{color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:12px;line-height:18px}.iSDaoW_switch{flex:none;align-items:center;display:inline-flex}.iSDaoW_checkbox{width:16px;height:16px;accent-color:var(--dsw-alias-brand-primary);cursor:pointer}";
		const tagId$4 = "@ha-na-bi/dsh-client-ui-custom/MarkdownRenderRow.module.css";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\ZcodeWorkspace\.zcode\workspace\default\deepseek-harness\packages\client\ui-custom\src\client\motion\MotionSection.module.css.mjs
		const css$2 = ".HPNNdq_section{flex-direction:column;gap:8px;display:flex}.HPNNdq_heading{margin:0;font-size:16px;font-weight:600;line-height:24px}.HPNNdq_intro{color:var(--dsw-alias-label-secondary);margin:0;font-size:13px;line-height:20px}.HPNNdq_row{justify-content:space-between;align-items:center;gap:16px;padding:12px 0;display:flex}.HPNNdq_rowDivider{border-top:1px solid var(--dsw-alias-border-l2)}.HPNNdq_rowDisabled{opacity:.5}.HPNNdq_rowText{min-width:0}.HPNNdq_title{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.HPNNdq_desc{color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:12px;line-height:18px}.HPNNdq_switch{flex:none;align-items:center;display:inline-flex}.HPNNdq_checkbox{width:16px;height:16px;accent-color:var(--dsw-alias-brand-primary);cursor:pointer}.HPNNdq_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.HPNNdq_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.HPNNdq_selector:disabled{cursor:default;color:var(--dsw-alias-label-tertiary)}.HPNNdq_chevron{flex:none}.HPNNdq_presets{flex:none;gap:6px;display:inline-flex}.HPNNdq_preset{border:1px solid var(--dsw-alias-border-l2);height:32px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:16px;padding:0 14px;font-size:13px;line-height:20px;transition:background-color .16s,border-color .16s,color .16s}.HPNNdq_preset:hover{border-color:var(--dsw-alias-brand-primary);background:var(--dsw-alias-interactive-bg-hover)}.HPNNdq_presetActive{border-color:var(--dsw-alias-brand-primary);background:color-mix(in srgb, var(--dsw-alias-brand-primary) 14%, transparent);color:var(--dsw-alias-label-primary)}";
		const tagId$2 = "@ha-na-bi/dsh-client-ui-custom/MotionSection.module.css";
		...
		var MotionSection_module_css_default = {
			"rowText": "HPNNdq_rowText",
			"selector": "HPNNdq_selector",
			"rowDivider": "HPNNdq_rowDivider",
			"presetActive": "HPNNdq_presetActive",
			"presets": "HPNNdq_presets",
			"section": "HPNNdq_section",
			"title": "HPNNdq_title",
			"intro": "HPNNdq_intro",
			"heading": "HPNNdq_heading",
			"switch": "HPNNdq_switch",
			"preset": "HPNNdq_preset",
			"desc": "HPNNdq_desc",
			"checkbox": "HPNNdq_checkbox",
			"row": "HPNNdq_row",
			"chevron": "HPNNdq_chevron",
			"rowDisabled": "HPNNdq_rowDisabled"
		};
		//#endregion
		...
		*/
		function MotionSection({ useMotion, setMotionEnabled, setMotionStyle, setSidebarMotionEnabled, setSidebarMotionStyle, setSelectionMotionEnabled, setNewChatMotionEnabled, setNewChatMotionStyle, setSettingsMotionEnabled, applyMotionPreset, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: MotionSection_module_css_default.section,
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", {
						className: MotionSection_module_css_default.heading,
						children: translator("title")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: MotionSection_module_css_default.intro,
						children: translator("intro")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: `${MotionSection_module_css_default.row} ${MotionSection_module_css_default.rowDivider}`,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: MotionSection_module_css_default.rowText,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: MotionSection_module_css_default.title,
								children: translator("presetTitle")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: MotionSection_module_css_default.desc,
								children: translator("presetDesc")
							})]
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: MotionSection_module_css_default.presets,
							role: "group",
							...
							children: MOTION_PRESETS.map((preset) => {
								...
								return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: `${MotionSection_module_css_default.preset} ${matchesPreset(scope?.value, preset.config) ? MotionSection_module_css_default.presetActive : ""}`,
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: `${MotionSection_module_css_default.row} ${MotionSection_module_css_default.rowDivider} ${enabled ? "" : MotionSection_module_css_default.rowDisabled}`,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: MotionSection_module_css_default.rowText,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: MotionSection_module_css_default.title,
							...
							className: MotionSection_module_css_default.switch,
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
								type: "checkbox",
								className: MotionSection_module_css_default.checkbox,
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: `${MotionSection_module_css_default.row} ${enabled ? "" : MotionSection_module_css_default.rowDisabled}`,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: MotionSection_module_css_default.rowText,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: MotionSection_module_css_default.title,
							...
							anchor: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
								type: "button",
								className: MotionSection_module_css_default.selector,
								disabled: !enabled,
								"aria-haspopup": "menu",
								"aria-expanded": open,
								onClick: () => {
								...
								children: [translator(selectedLabel), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { className: MotionSection_module_css_default.chevron })]
							})
						})]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: `${MotionSection_module_css_default.row} ${sidebarEnabled ? "" : MotionSection_module_css_default.rowDisabled}`,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: MotionSection_module_css_default.rowText,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: MotionSection_module_css_default.title,
							...
							anchor: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
								...
								children: [translator(sidebarSelectedLabel), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { className: MotionSection_module_css_default.chevron })]
							})
						})]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: `${MotionSection_module_css_default.row} ${newChatEnabled ? "" : MotionSection_module_css_default.rowDisabled}`,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: MotionSection_module_css_default.rowText,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: MotionSection_module_css_default.title,
							...
							anchor: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
								...
								children: [translator(newChatSelectedLabel), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { className: MotionSection_module_css_default.chevron })]
							})
						})]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		//#endregion
		//#region \0dsh-css:D:\ZcodeWorkspace\.zcode\workspace\default\deepseek-harness\packages\client\ui-custom\src\client\motion\motion.module.css.mjs
		const css$1 = ".dsu-motion-fade-up{animation:.28s cubic-bezier(.33,1,.68,1) both xO0q6W_dsu-motion-rise;animation-delay:var(--dsu-motion-delay,0s)}.dsu-motion-fade{animation:.24s cubic-bezier(.33,1,.68,1) both xO0q6W_dsu-motion-fade-in;animation-delay:var(--dsu-motion-delay,0s)}.dsu-motion-rise-scale{animation:.3s cubic-bezier(.33,1,.68,1) both xO0q6W_dsu-motion-rise-scale;animation-delay:var(--dsu-motion-delay,0s)}.dsu-motion-slide-in{animation:.28s cubic-bezier(.33,1,.68,1) both xO0q6W_dsu-motion-slide-in;animation-delay:var(--dsu-motion-delay,0s)}.dsu-motion-blur-in{animation:.3s cubic-bezier(.33,1,.68,1) both xO0q6W_dsu-motion-blur-in;animation-delay:var(--dsu-motion-delay,0s)}.dsu-motion-scale-in{animation:.28s cubic-bezier(.33,1,.68,1) both xO0q6W_dsu-motion-scale-in;animation-delay:var(--dsu-motion-delay,0s)}.dsu-motion-slide-left{animation:.28s cubic-bezier(.33,1,.68,1) both xO0q6W_dsu-motion-slide-left;animation-delay:var(--dsu-motion-delay,0s)}.dsu-motion-expand{animation:.28s cubic-bezier(.33,1,.68,1) both xO0q6W_dsu-motion-expand;animation-delay:var(--dsu-motion-delay,0s);transform-origin:top}.dsu-motion-slide-down{animation:.28s cubic-bezier(.33,1,.68,1) both xO0q6W_dsu-motion-slide-down;animation-delay:var(--dsu-motion-delay,0s)}.dsu-motion-panel{animation:.3s cubic-bezier(.33,1,.68,1) both xO0q6W_dsu-motion-panel}.dsu-motion-reveal{animation:.42s cubic-bezier(.33,1,.68,1) both xO0q6W_dsu-motion-reveal}@keyframes xO0q6W_dsu-motion-reveal{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}.dsu-motion-bloom{animation:.42s cubic-bezier(.33,1,.68,1) both xO0q6W_dsu-motion-bloom}@keyframes xO0q6W_dsu-motion-bloom{0%{opacity:0;transform:scale(.99)}to{opacity:1;transform:none}}.dsu-motion-zoom{animation:.4s cubic-bezier(.33,1,.68,1) both xO0q6W_dsu-motion-zoom}@keyframes xO0q6W_dsu-motion-zoom{0%{opacity:0;transform:scale(.97)}to{opacity:1;transform:none}}@keyframes xO0q6W_dsu-motion-panel{0%{opacity:.4;transform:translateY(6px)}to{opacity:1;transform:none}}.dsu-motion-select{animation:.32s cubic-bezier(.33,1,.68,1) both xO0q6W_dsu-motion-select}@keyframes xO0q6W_dsu-motion-select{0%{box-shadow:inset 0 0 #0000,inset 3px 0 #0000}to{box-shadow:inset 0 0 0 1px color-mix(in srgb, var(--dsu-accent,#4176e6) 45%, transparent), inset 3px 0 0 0 color-mix(in srgb, var(--dsu-accent,#4176e6) 90%, transparent)}}@keyframes xO0q6W_dsu-motion-rise{0%{opacity:0;transform:translateY(8px)}to{opacity:1;transform:none}}@keyframes xO0q6W_dsu-motion-fade-in{0%{opacity:0}to{opacity:1}}@keyframes xO0q6W_dsu-motion-rise-scale{0%{opacity:0;transform:translateY(8px)scale(.98)}to{opacity:1;transform:none}}@keyframes xO0q6W_dsu-motion-slide-in{0%{opacity:0;transform:translate(12px)}to{opacity:1;transform:none}}@keyframes xO0q6W_dsu-motion-slide-left{0%{opacity:0;transform:translate(-12px)}to{opacity:1;transform:none}}@keyframes xO0q6W_dsu-motion-blur-in{0%{opacity:0;filter:blur(6px);transform:translateY(4px)}to{opacity:1;filter:blur();transform:none}}@keyframes xO0q6W_dsu-motion-scale-in{0%{opacity:0;transform:scale(.97)}to{opacity:1;transform:none}}@keyframes xO0q6W_dsu-motion-expand{0%{opacity:0;transform:scaleY(.8)}to{opacity:1;transform:none}}@keyframes xO0q6W_dsu-motion-slide-down{0%{opacity:0;transform:translateY(-12px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){.dsu-motion-fade-up,.dsu-motion-fade,.dsu-motion-rise-scale,.dsu-motion-slide-in,.dsu-motion-blur-in,.dsu-motion-scale-in,.dsu-motion-slide-left,.dsu-motion-expand,.dsu-motion-slide-down,.dsu-motion-reveal,.dsu-motion-bloom,.dsu-motion-zoom{animation-name:xO0q6W_dsu-motion-fade-in;animation-duration:.1s;animation-delay:0s}.dsu-motion-select{animation:none}.dsu-motion-panel{animation:none}}";
		const tagId$1 = "@ha-na-bi/dsh-client-ui-custom/motion.module.css";
		...
		*/
				...
				for (const mutation of mutations) {
					if (mutation.type === "attributes") {
						if (mutation.attributeName === "aria-selected") {
							...
							if (target instanceof HTMLElement && target.matches(TREE_ITEM)) if (target.getAttribute("aria-selected") === "true") playSelectAnimation(target);
		...
		const tagId = "@ha-na-bi/dsh-client-ui-custom/custom.module.css";
		...
		*/
		function apply(ctx, config) {
			...
			const registerFeatures = () => {
				...
				if (enabled("motion")) {
					ctx.effect(() => ctx.locale.register(MOTION_NS, {
						zh,
						en
					...
					ctx.slots.inject("settings.section", () => ctx.slots.register({
						...
						inject: () => ({
							...
							setMotionEnabled: (value) => {
								scope.set("motionEnabled", value);
							},
							setMotionStyle: (style) => {
								scope.set("motionStyle", style);
							},
							setSidebarMotionEnabled: (value) => {
								scope.set("sidebarMotionEnabled", value);
							},
							setSidebarMotionStyle: (style) => {
								scope.set("sidebarMotionStyle", style);
							},
							setSelectionMotionEnabled: (value) => {
								scope.set("selectionMotionEnabled", value);
							},
							setNewChatMotionEnabled: (value) => {
								scope.set("newChatMotionEnabled", value);
							},
							setNewChatMotionStyle: (style) => {
								scope.set("newChatMotionStyle", style);
							},
							setSettingsMotionEnabled: (value) => {
								scope.set("settingsMotionEnabled", value);
							},
