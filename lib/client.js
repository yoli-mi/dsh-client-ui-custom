window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css = "html[data-dsu-anim] [data-dsu-motion=fade-up]{animation:.2s cubic-bezier(.2,0,0,1) both JgJjdW_dsu-fade-up}html[data-dsu-anim] [data-dsu-motion=sheet]{animation:.25s cubic-bezier(.2,0,0,1) both JgJjdW_dsu-sheet}html[data-dsu-anim] [data-dsu-motion=strip]{animation:.25s cubic-bezier(.2,0,0,1) both JgJjdW_dsu-strip}html[data-dsu-anim] [data-dsu-motion=node]{animation:.15s ease-out both JgJjdW_dsu-node}html[data-dsu-anim] [data-dsu-motion=press]:active{transition:transform .1s ease-out;transform:scale(.97)}@keyframes JgJjdW_dsu-fade-up{0%{opacity:0;transform:translateY(6px)}}@keyframes JgJjdW_dsu-sheet{0%{opacity:0;transform:scale(.97)}}@keyframes JgJjdW_dsu-strip{0%{opacity:0;transform:translateX(var(--dsu-strip-x,12px))}}@keyframes JgJjdW_dsu-node{0%{opacity:0}}@media (prefers-reduced-motion:reduce){html[data-dsu-anim] [data-dsu-motion]{animation-duration:.1s!important}html[data-dsu-anim] [data-dsu-motion=fade-up],html[data-dsu-anim] [data-dsu-motion=strip],html[data-dsu-anim] [data-dsu-motion=sheet]{animation-name:JgJjdW_dsu-node}html[data-dsu-anim] [data-dsu-motion=press]:active{transform:none}}";
		...
		*/
		function apply(ctx, config) {
			...
			const registerFeatures = () => {
				...
				if (enabled("animation")) document.documentElement.dataset.dsuAnim = "1";
			};
			registerFeatures();
