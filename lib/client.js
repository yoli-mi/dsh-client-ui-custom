window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css = "html[data-dsu-anim] [role=dialog]{animation:JgJjdW_dsu-dialog var(--dsu-anim-duration,.2s) var(--dsu-anim-ease,cubic-bezier(.2, 0, 0, 1)) both}html[data-dsu-anim] [role=presentation]{animation:.15s ease-out both JgJjdW_dsu-node}html[data-dsu-anim] [data-dsu-motion=fade-up]{animation:JgJjdW_dsu-fade-up var(--dsu-anim-duration,.2s) var(--dsu-anim-ease,cubic-bezier(.2, 0, 0, 1)) both}html[data-dsu-anim] [data-dsu-motion=sheet]{animation:JgJjdW_dsu-sheet var(--dsu-anim-duration,.2s) var(--dsu-anim-ease,cubic-bezier(.2, 0, 0, 1)) both}html[data-dsu-anim] [data-dsu-motion=strip]{animation:JgJjdW_dsu-strip var(--dsu-anim-duration,.2s) var(--dsu-anim-ease,cubic-bezier(.2, 0, 0, 1)) both}html[data-dsu-anim] [data-dsu-motion=node]{animation:.15s ease-out both JgJjdW_dsu-node}html[data-dsu-anim] [data-dsu-motion=press]:active{transition:transform .1s ease-out;transform:scale(.97)}@keyframes JgJjdW_dsu-fade-up{0%{opacity:0;transform:translateY(var(--dsu-anim-rise,6px))}}@keyframes JgJjdW_dsu-dialog{0%{opacity:0;transform:translateY(10px)scale(.99)}}@keyframes JgJjdW_dsu-sheet{0%{opacity:0;transform:scale(.97)}}@keyframes JgJjdW_dsu-strip{0%{opacity:0;transform:translateX(var(--dsu-strip-x,12px))}}@keyframes JgJjdW_dsu-node{0%{opacity:0}}html[data-dsu-anim][data-dsu-preset=focus] [data-dsu-motion=fade-up],html[data-dsu-anim][data-dsu-preset=focus] [data-dsu-motion=strip],html[data-dsu-anim][data-dsu-preset=focus] [data-dsu-motion=sheet],html[data-dsu-anim][data-dsu-preset=focus] [role=dialog],html[data-dsu-anim][data-dsu-preset=focus] [role=presentation]{animation-name:JgJjdW_dsu-node}html[data-dsu-anim][data-dsu-preset=focus] [data-dsu-motion=press]:active{transform:none}@media (prefers-reduced-motion:reduce){html[data-dsu-anim] [data-dsu-motion],html[data-dsu-anim] [role=dialog],html[data-dsu-anim] [role=presentation]{animation-duration:.1s!important}html[data-dsu-anim] [data-dsu-motion=fade-up],html[data-dsu-anim] [data-dsu-motion=strip],html[data-dsu-anim] [data-dsu-motion=sheet],html[data-dsu-anim] [role=dialog],html[data-dsu-anim] [role=presentation]{animation-name:JgJjdW_dsu-node}html[data-dsu-anim] [data-dsu-motion=press]:active{transform:none}}";
