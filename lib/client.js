window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function ShortcutsSection({ t, useShortcuts, useWorkspaces, useModels, setDraft, save, resetField, setDefaultWorkspace, addModelShortcut, removeModelShortcut, setModelShortcutCombo, setModelShortcutTarget }) {
		...
		*/
		function apply(ctx, config) {
			...
			ctx.effect(() => ctx.locale.register(APPEARANCE_NS, {
				zh: zh$4,
				en: en$4
			}), "ui-custom: appearance dictionaries");
			ctx.effect(() => ctx.locale.register(MARKETPLACE_NS, {
				zh: zh$3,
				en: en$3
			...
			ctx.effect(() => ctx.locale.register(MARKDOWN_NS, {
				zh,
				en
