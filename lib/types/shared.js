 ...
 */
export const FEATURES = ['history', 'markdown', 'appearance', 'marketplace', 'shortcuts', 'usage', 'animation'];
/** Motion style tiers for the 动效 section (easing / duration / travel). */
export const ANIMATION_STYLES = ['soft', 'standard', 'lively'];
/** Motion preset bundles for the 动效 section (whole-motion vs fade-only). */
export const ANIMATION_PRESETS = ['balanced', 'focus'];
