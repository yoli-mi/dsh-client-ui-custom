 ...
 */
import { isCornerRadius, isFocusGlow, isSurfaceShadow, isWallpaperTone, } from "./config.js";
const GLASS_LEVELS = ['off', 'light', 'frosted', 'mica'];
 ...
 */
export function configFromThemeSection(normalized, section) {
    ...
    const stringField = (value, fallback) => value !== undefined && value !== '' ? value : fallback;
    return {
        ...rest,
...
//# sourceMappingURL=theme-section.js.map