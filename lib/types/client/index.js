...
import { DEFAULT_MOTION_STYLE, DEFAULT_NEW_CHAT_MOTION_STYLE, DEFAULT_SIDEBAR_MOTION_STYLE, MOTION_PRESETS, isMotionPresetId, isMotionStyle, isNewChatMotionStyle, isSidebarMotionStyle, UI_CUSTOM_SETTINGS_NS, } from "../shared.js";
...
import { MOTION_NS, zh as motionZh, en as motionEn } from "./motion/motion-locales.js";
import { MotionSection } from "./motion/MotionSection.js";
import { installConversationEntrance } from "./motion/motion.js";
...
export function apply(ctx, config) {
    ...
    const syncSession = () => {
        ...
        if (current !== undefined)
            motionEngine.notifySessionSwitch();
    };
    syncSession();
    ...
    const registerFeatures = () => {
        ...
        if (enabled('motion')) {
            ctx.effect(() => ctx.locale.register(MOTION_NS, { zh: motionZh, en: motionEn }), 'ui-custom: motion dictionaries');
