...
import { ANIM_NS, en as animEn, zh as animZh } from "./animation/animation-locales.js";
import { AnimationSection } from "./animation/AnimationSection.js";
...
export function apply(ctx, config) {
    ...
    const registerFeatures = () => {
        ...
        if (enabled('animation')) {
            ...
            ctx.effect(() => ctx.locale.register(ANIM_NS, { zh: animZh, en: animEn }), 'ui-custom: animation dictionaries');
            ctx.slots.inject('settings.section', () => ctx.slots.register({
                name: 'settings.section',
            ...
            const applyMotion = () => {
                ...
                if (value.animationEnabled === false)
                    delete root.dataset.dsuAnim;
                else
                    root.dataset.dsuAnim = '1';
