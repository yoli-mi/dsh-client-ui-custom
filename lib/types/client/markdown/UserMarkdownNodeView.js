...
function UserBubbleActions({ text, time, t }) {
    ...
    return (_jsxs("div", { className: css.actions, children: [time !== undefined ? _jsx("span", { className: css.timeStart, children: formatClock(time, t) }) : null, _jsx(Tooltip, { label: copied ? t('copied') : t('copy'), side: "bottom", children: _jsx("button", { type: "button", className: css.action, "aria-label": copied ? t('copied') : t('copy'), onClick: onCopy, children: copied ? _jsx(IconCheckOutline16, {}) : _jsx(IconCopyOutline16, {}) }) })] }));
}
