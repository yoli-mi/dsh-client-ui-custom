...
export type UsageKey =
  | 'nav' | 'title' | 'intro' | 'close' | 'empty'
  | 'model.all'
  | 'range.year' | 'range.month' | 'range.week' | 'range.days3'
  | 'kpi.total' | 'kpi.input' | 'kpi.output' | 'kpi.cache' | 'kpi.cacheRate' | 'kpi.time' | 'kpi.sessions' | 'kpi.steps'
  | 'breakdown' | 'topSessions' | 'topEmpty'
